...
class model_backtest():
    ...
    def __init__(self):
        ...
        # 获取二级行业收盘价
        self.indus_close = pd.read_pickle('data/daily/indus/indus2_close')
    ...
    # end_date       计算回测净值曲线终止时间
    # -------------------------------------------------------------------------
    def clsfy_backtest(self, merge_factor, start_date, end_date, base):
...
#     # 指标复合
#     # df_factor = pd.read_pickle('gen_indus2_factor/north_results/north_change_orig_W_orig')
#     # df_factor = pd.read_pickle('gen_indus2_factor/margin_results/margin_tr_balance_orig_M_yoy')
#     # df_factor = pd.read_pickle('gen_indus2_factor/ETF_results/ETF_money_amount_M_qoq')
#     # df_factor = pd.read_pickle('gen_indus2_factor/industry_results/AShareSEO_preplan_recent_orig_W')
#     df_factor = pd.read_pickle('gen_indus2_factor/industry_results/MjrHolderTrade_under_recent_amount_W')
#     # df_factor = pd.read_pickle('gen_indus2_factor/margin_results/margin_slend_balance_orig_M_orig')
...
#     # 读取路径下所有行业指标
#     # path='gen_indus2_factor/north_results/'
#     # path='gen_indus2_factor/margin_results/'
#     # path='gen_indus2_factor/ETF_results/'
#     path='gen_indus2_factor/industry_results/'
...
#         # 存储回测结果
#         perf.to_excel('results/二级行业_{}.xlsx'.format(factor_name))
...
#         # 读取回测结果
#         perf = pd.read_excel('results/二级行业_{}.xlsx'.format(factor_name), index_col=0)
...
#     # 结果存储
#     merge_data.to_excel('结果整理/二级行业-增减持-2017.xlsx')
...
# =============================================================================
    ...
    for index in money_list:
        ...
        df_factor = pd.read_pickle('gen_indus2_factor/results/{}'.format(index))
    ...
    #         cur_score, start_time, end_time, base='mean') 
